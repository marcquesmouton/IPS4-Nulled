...
{	
	...
	public static function systemRequirements()
	{
		...
		if ( $return['requirements']['PHP']['version']['success'] and version_compare( $phpVersion, '5.5.0' ) == -1 )
		{
			$return['requirements']['PHP']['version']['message'] = \IPS\Member::loggedIn()->language()->addToStack( 'requirements_php_version_success_advice', FALSE, array( 'sprintf' => array( $phpVersion ) ) );
			$return['advice']['php'] = \IPS\Member::loggedIn()->language()->addToStack( 'requirements_php_version_advice', FALSE, array( 'sprintf' => array( $phpVersion ) ) );
		}

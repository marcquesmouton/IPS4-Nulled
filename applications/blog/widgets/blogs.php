...
class _blogs extends \IPS\Widget\PermissionCache
{
	...
	public function configuration( &$form=null )
	{
		...
		$form->add( new \IPS\Helpers\Form\Select( 'widget_feed_sort_on', isset( $this->configuration['widget_feed_sort_on'] ) ? $this->configuration['widget_feed_sort_on'] : 'blog_edate', FALSE, array( 'options' => array(
			'blog_edate'    => 'widget__blog_edate',
			'blog_entries'  => 'widget__blog_count_entries',
			'blog_comments' => 'widget__blog_count_comments'

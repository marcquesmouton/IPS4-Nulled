...
class _toolbar extends \IPS\Dispatcher\Controller
{
	protected static $defaultPlugins = array(
		...
		'clipboard',
		'colorbutton',
		'contextmenu', // This isn't actually present, but ipscontextmenu, which is the same thing, is, so we want to prevent people from adding this and recognise it as present for the requirements checker
		'dialog',
		'dialogui',
		'divarea',
		'elementspath',
